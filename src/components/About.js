    ...
    return ( 
        <div className="about">
            <div className="about-contributors">
                <h1>CONTRIBUTORS</h1>
                <p>During this pandamic there are people who want to help others by funding them or by any other means. Here we call them as Contributors. They can choose whom they want to help and do so from the comfort of their homes.</p>
            </div>
